...
(function ($) {
    ...
    function fnPjax(selector, container, options) {
        ...
        return this.on('click.pjax', selector, function (event) {
            ...
            if (!opts.container)
                if (dataPjax === '') opts.container = '#admui-pageContent';
                else opts.container = $(this).attr('data-pjax') || context;
        ...
        $.each(scripts, function (i, n) {
            ...
            if (deps) {
                ...
                if (waitLo !== 0) {
                    setTimeout(function () {
                        for (var v = 0; v < len; v++) {
                            if (scripts[0] === '') scripts.splice(0, 1)
                        }
                        fn(e, scripts)
                    }, 5);
                    return false
                ...
                script.onreadystatechange = function () {
                    if (script.readyState == "loaded" || script.readyState == "complete") {
                        ...
                        for (var f = 0; f < pjaxWaiting.script.length; f++) {
                            if (pjaxWaiting.script[f].src === this.src) pjaxWaiting.script.splice(f, 1)
                        }
                    }
                }
            } else {
    ...
    function waitLoad(deps, wait) {
        ...
        for (var i = 0; i < deps.length; i++) {
            for (var n = 0; n < wait.length; n++) {
                if (deps[i] === $(wait[n]).data('name')) unload.push('wait')
            }
        }
