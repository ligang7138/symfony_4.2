 ...
 */
namespace App\Yszc\AdminBundle\Twig;
...
class AdminExtension extends \Twig_Extension
{
    public function getFilters(){
        return array(
            ...
            new \Twig_SimpleFilter('diffBetweenTwoDays', array(\App\Yszc\AdminBundle\Common\CommonFunction::class, 'diffBetweenTwoDays')),
	        ...
	        new \Twig_SimpleFilter('gaddrbyip', array(\App\Yszc\AdminBundle\Common\CommonFunction::class, 'gaddrbyip')),
	        new \Twig_SimpleFilter('getSexByIdCard', array(\App\Yszc\AdminBundle\Common\CommonFunction::class, 'getSexByIdCard')),
	        new \Twig_SimpleFilter('getAgeByIdCard', array(\App\Yszc\AdminBundle\Common\CommonFunction::class, 'getAgeByIdCard')),
	        new \Twig_SimpleFilter('getBirthDayByIdCard', array(\App\Yszc\AdminBundle\Common\CommonFunction::class, 'getBirthDayByIdCard')),
	        new \Twig_SimpleFilter('getValueByJson', array($this, 'getValueByJson')),
	        new \Twig_SimpleFilter('getTimeDiff', array(\App\Yszc\AdminBundle\Common\CommonFunction::class, 'get_time_diff')),
        );
    }
    ...
    public function getValueByKey($key,$const,$keyName){
    	...
    	// 获取常量类的反射对象
    	$reflection = new \ReflectionClass("AdminBundle\Constant\\$const");
