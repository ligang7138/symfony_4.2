<?php
namespace App\Yszc\AdminBundle\Repository;
...
//		echo $where;die;
		$build
			->select('m.partnerId','m.partnerName','m.partnerAddTime','m.partnerCode','m.partnerIsBrand','m.partnerType', 'm.partnerStatus','m.uCode')
