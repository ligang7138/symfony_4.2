...
use App\AdminBundle\Entity\AdminSaleInvite;
use App\AdminBundle\Entity\YsUserMessage;
use App\AdminBundle\Services\Admin\Impl\AdminServiceImpl;
...
use App\AdminBundle\Entity\AdminRoles;
use App\AdminBundle\Entity\AdminMenus;
use App\AdminBundle\Entity\AdminModles;
use App\AdminBundle\Entity\EventActions;
...
class AdminController extends CommonController
{
    ...
    public function indexAction(){
        ...
        if(!is_object($curUser)){
            return new RedirectResponse('/f/login');
        }
